...
int main() {
    ...
    for (int i = 0; i < 5 ; ++i) {
        ...
        classRoster.add(singleStudent[0], singleStudent[1], singleStudent[2], singleStudent[3], stoi(singleStudent[4]), stoi(singleStudent[5]), stoi(singleStudent[6]), stoi(singleStudent[7]), <#DegreeProgram degreeprogram#>);
    }
